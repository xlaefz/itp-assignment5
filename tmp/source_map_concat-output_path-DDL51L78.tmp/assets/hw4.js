...
define('hw4/routes/demo', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({});
});
...
define('hw4/routes/search', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({});
});
...
define("hw4/templates/artists", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      var child0 = (function () {
        return {
          meta: {
            ...
            "moduleName": "hw4/templates/artists.hbs"
          },
          isEmpty: false,
          arity: 0,
          cachedFragment: null,
          ...
          statements: [["content", "artist.name", ["loc", [null, [5, 50], [5, 65]]], 0, 0, 0, 0]],
          locals: [],
          templates: []
        };
      })();
      return {
        ...
        statements: [["block", "link-to", ["artists.singleArtists", ["get", "artist.id", ["loc", [null, [5, 39], [5, 48]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [5, 4], [5, 77]]]]],
        locals: ["artist"],
        templates: [child0]
      };
    })();
    return {
      ...
      statements: [["block", "each", [["get", "model", ["loc", [null, [3, 8], [3, 13]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [3, 0], [7, 9]]]], ["content", "outlet", ["loc", [null, [9, 0], [9, 10]]], 0, 0, 0, 0]],
      locals: [],
      templates: [child0]
    };
  })());
});
define("hw4/templates/artists/single-artists", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      var child0 = (function () {
        return {
          meta: {
            ...
            "moduleName": "hw4/templates/artists/single-artists.hbs"
          },
          isEmpty: true,
          arity: 0,
          cachedFragment: null,
      ...
      return {
        ...
        statements: [["block", "song-item", [], ["song", ["subexpr", "@mut", [["get", "result", ["loc", [null, [7, 22], [7, 28]]], 0, 0, 0, 0]], [], [], 0, 0]], 0, null, ["loc", [null, [7, 4], [7, 44]]]]],
        locals: ["result"],
        templates: [child0]
      };
    })();
    return {
      ...
      statements: [["content", "model.songs.length", ["loc", [null, [3, 16], [3, 38]]], 0, 0, 0, 0], ["block", "each", [["get", "model.songs", ["loc", [null, [6, 10], [6, 21]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [6, 2], [8, 11]]]], ["content", "outlet", ["loc", [null, [11, 0], [11, 10]]], 0, 0, 0, 0]],
      locals: [],
      templates: [child0]
    };
  })());
});
define("hw4/templates/components/song-item", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        meta: {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.setAttribute(el1, "src", "https://media3.giphy.com/media/10HEuppNDdGEVO/200_s.gif");
    ...
    var child1 = (function () {
      return {
        ...
        statements: [["content", "song.price", ["loc", [null, [10, 13], [10, 27]]], 0, 0, 0, 0]],
        locals: [],
        templates: []
      };
    })();
    var child2 = (function () {
      return {
        ...
        statements: [["content", "song.price", ["loc", [null, [12, 14], [12, 28]]], 0, 0, 0, 0]],
        locals: [],
        templates: []
      };
    })();
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("p");
        var el3 = dom.createTextNode(" Play Count: ");
        dom.appendChild(el2, el3);
        var el3 = dom.createComment("");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode(" ");
      ...
      statements: [["content", "song.title", ["loc", [null, [2, 15], [2, 29]]], 0, 0, 0, 0], ["content", "song.playCount", ["loc", [null, [3, 20], [3, 38]]], 0, 0, 0, 0], ["block", "if", [["get", "isPopular", ["loc", [null, [4, 10], [4, 19]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [4, 4], [8, 12]]]], ["block", "if", [["get", "isExpensive", ["loc", [null, [9, 11], [9, 22]]], 0, 0, 0, 0]], [], 1, 2, ["loc", [null, [9, 5], [13, 12]]]]],
      locals: [],
      templates: [child0, child1, child2]
    };
  })());
});
define("hw4/templates/demo", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        meta: {
          ...
          "moduleName": "hw4/templates/demo.hbs"
        },
        isEmpty: false,
        arity: 0,
        cachedFragment: null,
        ...
        statements: [["content", "firstName", ["loc", [null, [10, 8], [10, 21]]], 0, 0, 0, 0]],
        locals: [],
        templates: []
      };
    })();
    ...
    return {
      ...
      statements: [["content", "outlet", ["loc", [null, [2, 0], [2, 10]]], 0, 0, 0, 0], ["inline", "input", [], ["type", "text", "value", ["subexpr", "@mut", [["get", "firstName", ["loc", [null, [4, 26], [4, 35]]], 0, 0, 0, 0]], [], [], 0, 0]], ["loc", [null, [4, 0], [4, 37]]], 0, 0], ["content", "firstName.length", ["loc", [null, [6, 13], [6, 33]]], 0, 0, 0, 0], ["block", "if", [["get", "firstName", ["loc", [null, [9, 6], [9, 15]]], 0, 0, 0, 0]], [], 0, 1, ["loc", [null, [9, 0], [13, 7]]]]],
      locals: [],
    ...
    var child0 = (function () {
      var child0 = (function () {
        return {
          ...
          statements: [["content", "artist.name", ["loc", [null, [5, 49], [5, 64]]], 0, 0, 0, 0]],
          locals: [],
          templates: []
        };
      })();
      return {
        ...
        statements: [["block", "link-to", ["artists.singleArtist", ["get", "artist.id", ["loc", [null, [5, 38], [5, 47]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [5, 4], [5, 76]]]]],
        locals: ["artist"],
        templates: [child0]
      };
    })();
...
define("hw4/templates/search", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      meta: {
        "revision": "Ember@2.8.1",
      ...
      statements: [["attribute", "onSubmit", ["subexpr", "action", ["search"], [], ["loc", [null, [null, null], [3, 36]]], 0, 0], 0, 0, 0, 0], ["inline", "input", [], ["type", "text", "value", ["subexpr", "@mut", [["get", "searchTerm", ["loc", [null, [4, 30], [4, 40]]], 0, 0, 0, 0]], [], [], 0, 0]], ["loc", [null, [4, 2], [4, 42]]], 0, 0], ["content", "outlet", ["loc", [null, [10, 0], [10, 10]]], 0, 0, 0, 0]],
      locals: [],
      templates: []
    };
  })());
});
define("hw4/templates/search/results", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      var child0 = (function () {
        return {
          meta: {
            ...
            "moduleName": "hw4/templates/search/results.hbs"
          },
          isEmpty: true,
          arity: 0,
          cachedFragment: null,
      ...
      return {
        ...
        statements: [["block", "song-item", [], ["song", ["subexpr", "@mut", [["get", "results", ["loc", [null, [7, 22], [7, 29]]], 0, 0, 0, 0]], [], [], 0, 0]], 0, null, ["loc", [null, [7, 4], [7, 45]]]]],
        locals: ["results"],
        templates: [child0]
      };
    })();
    return {
      ...
      statements: [["content", "outlet", ["loc", [null, [3, 0], [3, 10]]], 0, 0, 0, 0], ["block", "each", [["get", "model.results", ["loc", [null, [6, 10], [6, 23]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [6, 2], [8, 11]]]]],
      locals: [],
      templates: [child0]
    };
  })());
...
if (!runningTests) {
  require("hw4/app")["default"].create({"name":"hw4","version":"0.0.0+992de67c"});
}
